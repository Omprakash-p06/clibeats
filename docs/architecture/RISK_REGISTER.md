...
| **RISK-02** | **Infrastructure** | Railway free tier resource caps reached or IP range throttled by YouTube. | Medium | Medium | Stateless Gateway design allows instant deployment to alternative host (Fly.io, Render, self-hosted VPS). | Allow users to enter custom Gateway URL in App Settings. |
